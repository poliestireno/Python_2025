...
La condición de evaluación tiene que cambiar en algún momento. De no ser así, el bloque de repetición entrará en un bucle infinito a no ser que se aplique un break
...
En Python se puede acceder a la posición de un elemento a través de de posiciones negativas, siendo el elemento en la posición \-1 el último elemento de la lista, el \-2 el antepenúltimo y así sucesivamente.
...
Es posible desempaquetar una tupla, o lo que es lo mismo crear variables asignándolas de forma directa a los elementos que forman parte de esta.  
...
En caso de tener elementos duplicados dentro de un conjunto, Python elimina automáticamente los segundos datos duplicados
...
\# {1267}  
conjuntoDif \= conjunto1.symmetric\_difference(conjunto2)

A modo resumen, se muestra una tabla con las principales diferencias entre cada una de las estructuras
